...
public class NumeroEnTexto {
    ...
    public static String convertirAString(double numero) {
        String num = String.valueOf(numero);
        double decimal = Double.valueOf(num.substring(num.indexOf(".") + 1));
        return (decimal == 0) ? num.substring(0, num.indexOf(".")) : num;
    }

    private static String convertir(String numero, boolean mayusculas) {
        String literal = "";
