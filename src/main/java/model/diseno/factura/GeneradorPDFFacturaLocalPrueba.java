...
public class GeneradorPDFFacturaLocalPrueba extends GeneradorPDFFactura {

    private Document documento;
    private DecimalFormat decimal;

    public GeneradorPDFFacturaLocalPrueba(Arrendatario arrendatario, Inmueble inmueble, Contrato contrato, Configuracion configuracion, Boolean version) {
    ...
    private void rellenarTablaArrendador() throws DocumentException {
        ...
        /*PdfPCell cell2t = new PdfPCell(new Phrase("Caridad Reyes Moséguez\n"
                ...
                + "35118 Agüimes\n"
                + "NIF 42883415F\n"));*/
        PdfPCell cell2t = new PdfPCell(new Phrase("Ignacio Marín Jiménez\n"
                + "Avda. Polizón nº 24\n"
                + "35118 Agüimes\n"
                + "NIF 15909567F\n"));
        cell2t.setPadding(5);
    ...
    private void rellenarContenido(LocalDate fechaFactura) throws DocumentException {
        ...
        if (arrendatario.getApellidos() != null) { // es una persona física                    
            ...
            contenido.add(new Chunk(NumeroEnTexto.convertirNumeroATextoDouble(contrato.getPrecio2Inmueble(), false) + " euros ( " + decimal.format(contrato.getPrecio2Inmueble()) + " € )", fuenteNegrita));
